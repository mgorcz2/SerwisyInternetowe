'''
Przygotować korutynę, która asynchronicznie pobierze prognozę pogody dla
 przekazanych miast, a następnie zwróci te prognozy połączone w
 jeden słownik, posortowany malejąco według średniej temperatury następnego dnia.
'''
